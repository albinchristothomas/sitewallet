      ...
      <div className="mt-6 print:mt-0" id="report-wrap">
        <article
          ...
          style={{
            ...
            overflow: "hidden",
            background: paperBg,
            // Without this, Download PDF (window.print) drops the band/table
            // backgrounds and the header prints near-invisible.
          ...
          >
                      ...
                      >
                        ...
                        <div
                          style={{
                            ...
                            fontFamily: mono,
                            fontSize: 9.5,
                            color: r.compliant ? "#1e8a4c" : "#b8730f",
                            fontWeight: 600,
                          }}
                        >
                          {/* OVERRIDE = admitted despite expired/missing
                              tickets — the medic's logged override call. */}
                          {r.compliant ? "● VALID" : "● OVERRIDE"}
                        </div>
                        <div
                          style={{
                            flex: 0.9,
            ...
            >
              ...
              >
                ...
                >
                  OFFICIAL RECORD · GENERATED BY RIGWISE
                  <br />
                  {fmtTime(new Date().toISOString())} · AMERICA/EDMONTON
                </div>
                <div
                  style={{
                    width: 56,
        ...
        >
          ...
          {new Date().toLocaleString("en-CA", { timeZone: SITE_TZ })} by RigWise
          · rigwise.ca
        </p>
      </div>
