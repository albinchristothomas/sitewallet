...
export function NavMenu({
  ...
  roleLabel: string;
  profileHref: string;
  /** Owner-only entry (the People roster); omitted for everyone else. */
  ownerHref?: string;
    ...
    <div ref={rootRef} style={{ position: "relative" }}>
      ...
      {open && (
        ...
        >
          ...
          />
          {ownerHref && (
            <Link href={ownerHref} className={itemCls} onClick={() => setOpen(false)}>
              <svg
                width="16"
                height="16"
                viewBox="0 0 24 24"
              ...
              >
                ...
                <path d="M21.5 19a5 5 0 0 0-6-4.6" />
              </svg>
              People
            </Link>
          )}
